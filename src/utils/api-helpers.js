...
class APIHelper {
  ...
  static get ABOUT_SLIDERS_URL() {
    return `${this.ABOUT_URL}sliders/`;
  }
   ...
   */
  static fetchProjectTechnologies(project_id) {
    return this._fetchObject(this.PROJECTS_URL, project_id, 'technologies');
  }

  /**
   * Get course info for a project.
   */
  static fetchProjectCourse(project_id) {
    return this._fetchObject(this.PROJECTS_URL, project_id, 'course');
  }
   ...
   */
  static fetchCourseProjects(course_id) {
    return this._fetchObject(this.COURSES_URL, course_id, 'projects');
  }
  ...
  /**
   * Get all about page slider's slids.
   */
  static fetchAboutSliders() {
    return this._fetchObject(this.ABOUT_SLIDERS_URL);
  }
